    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-10">
        ...
        <div className="hidden items-center gap-8 md:flex">
          ...
          <a href="/#features" className="text-sm font-medium text-white/70 transition hover:text-white">
            Features
          </a>

          {user ? (
            <div className="flex items-center gap-4">
              <Link href="/profile" className="text-sm font-medium text-white/70 transition hover:text-white">
                Profile
              </Link>
              <form action={logout}>
                <button
