...
import ResortMapLoader from "@/components/resort-map-loader";
import type { MapResort } from "@/components/resort-map";
...
function ResortCard({ resort }: { resort: ResortWithWeather }) {
  ...
  return (
    <Link href="/resorts" className="group relative flex flex-col overflow-hidden rounded-2xl bg-white shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl">
    ...
    <main className="bg-cream">
      ...
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
        <Image
          ...
          fill className="object-cover" preload
        />
