...
function PriceLevel({ level, price }: { level: number; price: number }) {
  return (
...
function ResortCard({ resort }: { resort: ResortWithWeather }) {
  ...
  return (
    <div className="group flex flex-col overflow-hidden rounded-2xl bg-navy-light ring-1 ring-white/10 transition duration-300 hover:-translate-y-0.5 hover:ring-gold/30 hover:shadow-xl hover:shadow-navy/40">
      {/* Image */}
...
export default function ResortSearch({ resorts }: { resorts: ResortWithWeather[] }) {
